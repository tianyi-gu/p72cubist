...
- **Robustness data:** `outputs/data/robustness/{variant}_seed{N}.json` (per-seed tournament runs for leaderboard-stability measurement). Generated by `scripts/robustness_test.py`, aggregated by `scripts/robustness_summary.py`. Not surfaced in the web app. See `outputs/data/robustness/README.md`.
